...
```powershell
cargo run --manifest-path tools/mnue_x2_trainer/Cargo.toml --features cuda -- --arch x2-k16-pawn-q8-a384 --data D:/NNUE/data/train_3b_shuffled.data --export D:/NNUE/nets/mnue/mnue_x2_k16_pawn_q8_a384.mnue --batch-size 65536 --threads 12 --superbatches 4 --lr 0.001 --lr-final 0.0001
```
...
```text
setoption name MNUEfile value D:\NNUE\nets\mnue\mnue_x2_k16_pawn_q8_a384_long.mnue
position startpos
eval
go depth 1
