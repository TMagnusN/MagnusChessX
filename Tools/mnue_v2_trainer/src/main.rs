...
use mnue_data_schedule::{
    DataScheduleOptions, build_data_schedule, input_data_kind_name, print_startup_log,
};
use mnue_v2_trainer::{
...
fn main() {
    ...
    let data_schedule = build_data_schedule(DataScheduleOptions {
        explicit_paths: cli.data.clone(),
