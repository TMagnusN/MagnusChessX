...
This project intentionally depends on D:/bullet without modifying that dirty
working tree. Training data and output paths point at D:/NNUE.
*/
...
const OUTPUT_DIR: &str = "D:/NNUE/runs/mnue_x1_768_300m";
const NET_DIR: &str = "D:/NNUE/nets/mnue";
const NET_ID: &str = "mnue_x1_768_300m";
